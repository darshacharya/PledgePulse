  ...
  return (
    <div className="bg-vintage p-4 rounded-lg shadow-lg h-full border-4 border-vintage-border hover:border-vintage-border-hover transition-all flex flex-col justify-between">
      <div className="flex flex-col items-center gap-1 mb-2">
        <h2 className="subtitle-scale font-bold text-white font-poppins border-b-2 border-white pb-1 text-center text-2xl">
          {oathText}
        </h2>
      </div>
      <p className="text-white oath-scale font-thinbold italic font-poppins text-center">
        {oathDescription}
      </p>
      <hr />
